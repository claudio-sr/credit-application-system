package com.claudio.credit.application.system.repository
...
class CreditRepositotyTest {
    ...
    fun `should find all credits by customer id`() {
        ...
        //when
        val creditsList: List<Credit> = creditRepository.findAllByCustomerId(customerId)
    ...
    private fun buildCustomer(
        ...
        email: String = "arya@gmail.com",
        password: String = "12345",
        zipCode: String = "12345",
        street: String = "Reino do Norte",
